...
```{r}
ggplot(out3,aes(year,mean_trim))+geom_line(color="green")+geom_line(aes(year,weighted_mean),color="red")+labs(x="year", y="Life Expectancy",title="MyPlot")+scale_fill_discrete(name="",labels=c("mean_trim","weighted_mean"))
```
