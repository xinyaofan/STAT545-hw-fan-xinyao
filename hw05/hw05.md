...
#p1<-sl_drop %>% 
  #filter(year > 2000) %>%
  #filter(artist_hotttnesss>0.9)%>%
  #ggplot(aes(x=year))+geom_bar(aes(weight=artist_hotttnesss, fill=artist_name_1),position="dodge",colour="black")+scale_y_continuous("hotttnesss")
```
